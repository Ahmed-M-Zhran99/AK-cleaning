...
@section('content')
    ...
    <main>
        ...
        <section class="hero-section hero-section-full-height d-flex justify-content-center align-items-center" style="position: relative; z-index: 0; background: none;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12 text-center mx-auto">
                        <h1 class="cd-headline rotate-1 text-white mb-4 pb-2">
                            ...
                            <span class="cd-words-wrapper" style="width: 206px;">
                                    <b class="is-hidden">House</b>
                                    <b class="is-visible">Office</b>
                                    <b class="is-hidden">Kitchen</b>
                                </span>
                        </h1>
            ...
            <div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 680px; width: 1519px; z-index: -999998; position: absolute;"><img style="position: absolute; margin: 0px; padding: 0px; border: none; width: 1519px; height: 1012.67px; max-height: none; max-width: none; z-index: -999999; left: 0px; top: -166.333px;" src="images/slideshow/afro-woman-holding-bucket-with-cleaning-items.jpg" class="deleteable"><img style="position: absolute; margin: 0px; padding: 0px; border: none; width: 1519px; height: 1013.68px; max-height: none; max-width: none; z-index: -999999; opacity: 0.644516; left: 0px; top: -166.84px;" src="images/slideshow/unrecognizable-cleaner-walking-into-hotel-room-with-tools-detergents.jpg"></div></section>
