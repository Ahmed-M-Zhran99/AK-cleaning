...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="{{url('Ds')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
...
<!-- Sidebar End -->
    ...
    <div class="content position-relative">
        ...
        <!-- Footer Start -->
        <div class="container-fluid pt-4 px-4 position-absolute bottom-0 w-100">
