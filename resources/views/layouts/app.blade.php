...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="{{ route('ak.index') }}">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('ak.index') }}">Home</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ak.about') }}">About Us</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                        <li><a class="dropdown-item" href="{{route('ak.service')}}">Our Services</a></li>

                        <li><a class="dropdown-item" href="{{ route('ak.comingSoon') }}">Coming Soon</a></li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ak.contact') }}">Contact</a>
                </li>

                <li class="nav-item ms-3">
                    <a class="nav-link custom-btn custom-border-btn custom-btn-bg-white btn" href="{{route('Dash.index')}}">Get started</a>
                </li>
            </ul>
        </div>
    </div>
